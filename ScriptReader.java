...
public class ScriptReader {
  ...
  /**
   * Public constructor to read and process a script text file This text file include function calls
   * for heap operations.
   */
  ...
  /**
   * Method to check if the string matches the method names. If yes, then process and run the
   * according methods If no, return 0
   *
   ...
   *
   * @param line an input line
   * @return an array of integers containing 2 int arguments, {-1,-1} if the input lacks either one
   * or both the arguments or the arguments is not a number
   */
   ...
   *
   * @param line an input line
   * @return an argument as a double, -1 if the input is invalid either because of argument is empty
